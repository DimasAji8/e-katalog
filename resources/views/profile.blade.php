<div class="container px-6 py-16 mx-auto">
    <div class="items-center lg:flex">
        <div class="flex items-center justify-center w-full mt-6 lg:mt-0 lg:w-1/2">
            <img class="w-full h-full lg:max-w-3xl filter hue-rotate-90" src="https://merakiui.com/images/components/Catalogue-pana.svg" alt="Catalogue-pana.svg">
        </div>
        <div class="w-full lg:w-1/2 lg:mx-10">
            ...
            <div class="lg:max-w-lg">
                ...
                <p class="mt-3 text-gray-600 dark:text-gray-400 text-lg text-justify">{{ $item->isi }}</p>
                <br>
