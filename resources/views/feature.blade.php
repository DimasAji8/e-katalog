    ...
    <div class="container px-6 py-10 mx-auto">
        <div class="lg:flex lg:items-center">
            <div class="w-full space-y-12 lg:w-1/2 ">
                <div>
                    <h1 class="text-2xl font-semibold text-gray-800 capitalize lg:text-3xl dark:text-white">Belanja Menjadi Lebih Mudah <br> Lengkap & Nyaman</h1>
                ...
                <div class="md:flex md:items-start md:-mx-4">
                    <span class="inline-block p-2 text-red-500 bg-red-100 rounded-xl md:mx-4 dark:text-white dark:bg-red-500">
                    ...
                    <div class="mt-4 md:mx-4 md:mt-0">
                        <h1 class="text-xl font-semibold text-gray-700 capitalize dark:text-white">Kualitas dan Desain untuk Setiap Ruang</h1>

                        <p class="mt-3 text-gray-500 dark:text-gray-300">
                            Kami menyediakan keramik berkualitas tinggi dengan desain inovatif untuk memenuhi kebutuhan interior modern Anda.
                        </p>
                    </div>
                </div>
                ...
                <div class="md:flex md:items-start md:-mx-4">
                    ...
                    <div class="mt-4 md:mx-4 md:mt-0">
                        <h1 class="text-xl font-semibold text-gray-700 capitalize dark:text-white">Desain Modern, Kualitas Terjamin</h1>

                        <p class="mt-3 text-gray-500 dark:text-gray-300">
                            Produk kami hadir dengan pilihan desain elegan dan tahan lama, cocok untuk berbagai kebutuhan hunian.
                        </p>
                    </div>
                </div>
                ...
                <div class="md:flex md:items-start md:-mx-4">
                    ...
                    <div class="mt-4 md:mx-4 md:mt-0">
                        <h1 class="text-xl font-semibold text-gray-700 capitalize dark:text-white">Pilih yang Terbaik untuk Setiap Karya</h1>

                        <p class="mt-3 text-gray-500 dark:text-gray-300">
                            Menawarkan keramik premium yang memberikan nilai estetika dan ketahanan maksimal untuk setiap ruangan.
                        </p>
                    </div>
                </div>
            </div>
     ...
     src="{{ asset('banner/Screenshot 2025-01-02 091725.png') }}" 
     alt="Our Feature">
