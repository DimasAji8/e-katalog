    ...
    <div class="container px-6 py-10 mx-auto">
        <div class="lg:flex lg:items-center">
            <div class="w-full space-y-12 lg:w-1/2 ">
                <div>
                    <h1 class="text-2xl font-semibold text-gray-800 capitalize lg:text-3xl dark:text-white">explore our <br> Keramik Kami</h1>
                ...
                <div class="md:flex md:items-start md:-mx-4">
                    ...
                    <div class="mt-4 md:mx-4 md:mt-0">
                        ...
                        <p class="mt-3 text-gray-500 dark:text-gray-300">
                            Keramik kami hadir dengan pilihan desain elegan dan tahan lama, cocok untuk berbagai kebutuhan hunian.
                        </p>
                    </div>
                </div>
